...
execute if score #Prop Hi9j_dHP_Var matches 50..100 run data modify storage hi9j_disphealth heart set value '[{"text":"❤ HP ","color":"yellow"},{"score":{"objective":"Hi9j_dHP_Value", "name": "@s"},"color":"yellow","bold":true}]'
execute if score #Prop Hi9j_dHP_Var matches 50..100 run data modify storage hi9j_disphealth heart set value '[{"text":"❤ HP ","color":"green"},{"score":{"objective":"Hi9j_dHP_Value", "name": "@s"},"color":"green","bold":true}]'
