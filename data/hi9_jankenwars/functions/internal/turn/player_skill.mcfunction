...
execute if score ActionState Hi9j_Var matches 0 run tag @e[tag=Hi9j_SkillPlayer] remove Hi9j_SkillPlayer
execute if score ActionState Hi9j_Var matches 0 run execute as @e[predicate=hi9_jankenwars:alive-players] run execute if score @s Hi9j_Participant = ActionPlayer Hi9j_Var run tag @s add Hi9j_SkillPlayer
execute if score ActionState Hi9j_Var matches 0 run tellraw @a[tag=Hi9j_Dbg] [{"text":"// ", "color":"gray"},{"score":{"objective": "Hi9j_Var","name": "ActionPlayer"}},{"text":" Pre-action of "},{"selector":"@e[tag=Hi9j_SkillPlayer]"}]
...
execute if score ActionState Hi9j_Var matches 100 run tellraw @a[tag=Hi9j_Dbg] [{"text":"// ", "color":"gray"},{"text":" Pre-action 完了 "},{"selector":"@e[tag=Hi9j_SkillPlayer]"}]
execute if score ActionState Hi9j_Var matches 100 run scoreboard players add ActionPlayer Hi9j_Var 1
execute if score ActionState Hi9j_Var matches 100 run scoreboard players set ActionState Hi9j_Var 0
