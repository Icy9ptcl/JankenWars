execute if score FirstRun Hi9j_Dice_Var matches 1 run function hi9_jankenwars:internal/turn/tuba/game/dice/resetcount
...
execute unless entity @e[tag=Hi9j_Roller] run scoreboard players remove Time Hi9j_Dice_Var 1
