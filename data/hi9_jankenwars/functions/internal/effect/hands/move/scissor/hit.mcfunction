...
playsound minecraft:entity.player.attack.sweep player @a ~ ~ ~ 1 1.4
playsound minecraft:item.armor.equip_diamond player @a ~ ~ ~ 0.6 1
playsound minecraft:item.armor.equip_diamond player @a ~ ~ ~ 0.6 0.7
playsound minecraft:item.armor.equip_diamond player @a ~ ~ ~ 0.6 0.5
playsound minecraft:item.armor.equip_diamond player @a ~ ~ ~ 0.6 1.2
playsound minecraft:item.armor.equip_iron player @a ~ ~ ~ 0.6 1.2
playsound minecraft:item.armor.equip_iron player @a ~ ~ ~ 0.6 1.2
